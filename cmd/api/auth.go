...
func (app *applicaion) registerUserHandler(w http.ResponseWriter, r *http.Request) {
...
func (app *applicaion) createTokenHandler(w http.ResponseWriter, r *http.Request) {
